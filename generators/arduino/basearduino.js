...
Blockly.Arduino.inout_digital_write_var = function() {
  var dropdown_pin = Blockly.Arduino.valueToCode(this, 'PIN', Blockly.Arduino.ORDER_ATOMIC) || '1'
  var dropdown_stat = Blockly.Arduino.valueToCode(this, 'STATUS', Blockly.Arduino.ORDER_ATOMIC) || 'HIGH'
  Blockly.Arduino.setups_['setup_output_' + dropdown_pin] = 'pinMode(' + dropdown_pin + ', OUTPUT);';
  var code = 'digitalWrite(' + dropdown_pin + ', ' + dropdown_stat + ');\n'
  return code;
};
...
Blockly.Arduino.declare_var = function() {
  var value_name = Blockly.Arduino.valueToCode(this, 'NAME', Blockly.Arduino.ORDER_ATOMIC) || '1'
  var value_num = Blockly.Arduino.valueToCode(this, "NUM", Blockly.Arduino.ORDER_ATOMIC);
  Blockly.Arduino.definitions_['setup_declare_var' + value_name] = 'int ' + value_name + ' = ' + value_num + ';\n';
