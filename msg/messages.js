...
Blockly.Msg.ARD_ANALOGREAD = 'AnalogRead PIN#';
Blockly.Msg.ARD_ANALOGREAD_TIP = 'Return value between 0 and 1024';
Blockly.Msg.ARD_ANALOGWRITE = 'AnalogWrite PIN#';
Blockly.Msg.ARD_VALUE = "value";
Blockly.Msg.ARD_ANALOGWRITE_TIP = 'Write analog value between 0 and 255 to a specific Port';
Blockly.Msg.ARD_DIGITALREAD = 'DigitalRead PIN#';
Blockly.Msg.ARD_DIGITALREAD_TIP = 'Read digital value on a pin: HIGH or LOW';
Blockly.Msg.ARD_DIGITALWRITE = 'DigitalWrite PIN#';
Blockly.Msg.ARD_DIGITALWRITE_STATUS = 'Stat';
Blockly.Msg.ARD_DIGITALWRITEVAR_TIP = 'Write digital value HIGH or LOW to a specific Port';
Blockly.Msg.ARD_DIGITALWRITEVAR_TIP = 'Write digital value to a Port, the value and port can be computed variables';
Blockly.Msg.ARD_BUILDIN_LED = 'Build-in LED Stat';
Blockly.Msg.ARD_BUILDIN_LED_TIP = 'Light on or off for the build-in LED of the Arduino';
Blockly.Msg.ARD_DEFINE = 'Define';
Blockly.Msg.ARD_DELAY = 'Delay';
Blockly.Msg.ARD_DELAY_TIP = 'Delay specific time';
...
Blockly.Msg.ARD_SERIAL_PRINT = 'Serial Print';
Blockly.Msg.ARD_SERIAL_PRINT_TIP = 'Prints data to the console/serial port as human-readable ASCII text.';
Blockly.Msg.ARD_READ_DEG = 'Read Degrees';
Blockly.Msg.ARD_READ_DEG_TIP = 'return that degree with the last servo move.';
Blockly.Msg.ARD_READ_DEG_180 = 'Degree (0~180)';
Blockly.Msg.ARD_READ_DEG_180_TIP = 'Move between 0~180 degree';
Blockly.Msg.ARD_MILLIS = 'Milliseconds';
Blockly.Msg.ARD_MILLIS_TIP = 'Returns number of milliseconds since startup of the Arduino. Has to be stored in a positive long integer';
