...
Blockly.Msg.ARD_ANALOGREAD = "LeesAnaloog PIN#";
Blockly.Msg.ARD_ANALOGREAD_TIP = "Geeft waarde terug tussen 0 and 1024 zoals gelezen op de PIN";
Blockly.Msg.ARD_ANALOGWRITE = "SchrijfAnaloog PIN#";
Blockly.Msg.ARD_ANALOGWRITE_TIP = "Schrijf analoge waarde tussen 0 en 255 naar de opgegeven PIN";
...
Blockly.Msg.ARD_BUILDIN_LED = "Ingebouwde LED Status";
Blockly.Msg.ARD_BUILDIN_LED_TIP = "Licht aan of uit voor de ingebouwde LED op de Arduino";
Blockly.Msg.ARD_DEFINE = "Definieer";
Blockly.Msg.ARD_DELAY = "Wacht";
Blockly.Msg.ARD_DELAY_TIP = "Wacht de opgegeven tijd in milliseconden (duizendsten van een seconde)e";
Blockly.Msg.ARD_DIGITALREAD = "LeesDigitaal PIN#";
Blockly.Msg.ARD_DIGITALREAD_TIP = "Geeft waarde terug gelezen op de digitale PIN: HOOG of LAAG";
Blockly.Msg.ARD_DIGITALWRITE = "SchrijfDigitaal PIN#";
...
Blockly.Msg.ARD_DIGITALWRITE_STATUS = "Status";
...
Blockly.Msg.ARD_MILLIS = "Milliseconden";
Blockly.Msg.ARD_MILLIS_TIP = "Geeft aantal milliseconden terug sinds start van de Arduino. Moet je opslaan in een positief lang geheel getal!";
Blockly.Msg.ARD_NOTONE_PIN = "Geen toon op PIN#";
Blockly.Msg.ARD_NOTONE_PIN_TIP = "Stop met een toon op de gegeven pin";
Blockly.Msg.ARD_READ_DEG = "Lees Graden";
Blockly.Msg.ARD_READ_DEG_180 = "Graden (0~180)";
Blockly.Msg.ARD_READ_DEG_180_TIP = "Beweeg Servo naar 0~180 graden";
Blockly.Msg.ARD_READ_DEG_TIP = "Geeft graden terug gedaan in laatste Servo beweging.";
Blockly.Msg.ARD_SERIAL_PRINT = "Serieel Afdrukken";
...
Blockly.Msg.REPLACE_EXISTING_BLOCKS = "Vervang aanwezige blokken? \"Annuleren\" zal blokken samenvoegen";
